...
def test_api():
    ...
    urls = [
        "https://studio.suno.com/api/feed/?page=0",
        "https://studio-api.suno.com/api/feed/?page=0",
        "https://api.suno.com/api/feed/?page=0",
        "https://suno.com/api/feed/?page=0",
        "https://suno.com/api/library/",
